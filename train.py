...
def buildmodel(summary):
	...
	model.add(Dense(128, init=weight_init, bias=True))
	model.add(LeakyReLU(alpha=0.3))
	model.add(BatchNormalization())
	model.add(Dense(64, init=weight_init, bias=True))
	model.add(LeakyReLU(alpha=0.3))
	model.add(BatchNormalization())
	model.add(Dropout(0.5))
	model.add(Dense(32, init=weight_init))
	model.add(LeakyReLU(alpha=0.3))
	model.add(BatchNormalization())
...
numpy_accuracy_history = np.array(mse_history)
